...
document.getElementById('column1').innerHTML+="<p>Woah! Me and my jowa!</p>";
document.getElementById('column1').innerHTML+="<p>Hey Yoghost!</p>";
...
document.getElementById('column2').style.color="#00F2FF";
document.getElementById('column2').style.background="#000000";
document.getElementById('column2').style.fontSize="16pt";
